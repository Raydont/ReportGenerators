...
namespace MSO.NetTDocs.Excel
{
    public class ExcelReader
    {
        ...
        public void ApplyStyle()
        {
            ...
            // ѕолучаем диапазон, содержащий все свойства документа
            Style sty;
            try
            {
            ...
            _workSheet.PageSetup.BottomMargin = 50.36;
            _workSheet.PageSetup.FooterMargin = 22.4;
            _workSheet.PageSetup.RightMargin = 5;
            _workSheet.PageSetup.LeftMargin = 50;
        ...
        // выравнивание текста в €чейке по правому краю
        public void rightTextCell(string cell)
        {
            _range = _workSheet.get_Range(cell, cell);
            _range.VerticalAlignment = XlVAlign.xlVAlignBottom;
            _range.HorizontalAlignment = XlHAlign.xlHAlignRight;
        }

        // выравнивание текста в €чейке по правому краю
        public void rightTextCell(int row, int col)
        {
            rightTextCell(cellNumToAlphabet(row, col));
        }
