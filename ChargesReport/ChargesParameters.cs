...
namespace ChargesReport
{
    public class ChargesParameters
    {
        ...
        public static class WorkerGuid
        {
            ...
            public static readonly Guid ProfessionInCombination = new Guid("367b2f06-a724-43b6-a9f0-e1cf53a482a5");  //Профессия по совместительству
            public static readonly Guid PersentAdditionalAwards2 = new Guid("4bb45aa3-10a0-404d-8f6e-7ddf0e2e4806"); //Процент дополнительной премии для профессии по совместительству
        ...
        public static class CostHoursOverFullfilledTimeGuid
        {
            ...
            public static readonly Guid NameFullFilledGuid = new Guid("6748e304-49cb-4f00-ae04-88b2361b04cf");               // Наименование профессии (Станочники и остальные профессии) справочника Стоимость нормо-часов свыше нормы         
        }
        ...
        public static class ChargesGuid
        {
            ...
            public static readonly Guid NormoHours = new Guid("3c74de09-5858-4a5f-ba2b-8f17fdfcedea");
            ...
            public static readonly Guid OvertimeFirst2Hours = new Guid("4391b5bb-5162-490d-80f8-e7a934db566e"); //Сверхурочные первые 2 часа
            public static readonly Guid OvertimeNextHours = new Guid("c2c197c6-e180-49ea-9b86-995831cc8dad");   //Сверхурочные последующие часы
            public static readonly Guid SverkhurochnyeGOZ = new Guid("50e7afa3-64be-4112-b708-ba004b4b4e49");   //Сверхурочные ГОЗ
            ...
            public static readonly Guid PercentForExtraCharges = new Guid("0e00186e-33b5-479c-8561-7e1d99a2ca95");     //Процент для надбавок 
            public static readonly Guid Comment = new Guid("93fa8578-c8d6-451f-bbda-b362a334268d");
            public static readonly Guid TariffCategoryLink = new Guid("c2317d31-2867-4026-b3a4-64e8fc92e734");   // Межразрядная разница
            public static readonly Guid CountHoursWorkGuid = new Guid("312ebe66-2f60-4a80-9d36-d70c523c0f32"); // Количество отработанных часов для работы
            public static readonly Guid ПрофессияВыполняемойРаботы = new Guid("58b10de1-38d9-4499-9626-f031cd8f34a2");
            public static readonly Guid Pupil = new Guid("0553feea-0c97-4d8e-b15e-0ae175c0bc8c");   // Ученик
            public static readonly Guid SumSalaryTariffCategoryLink = new Guid("2763c3f8-4f30-4ab2-a70b-1b46c00bf534");
            public static readonly Guid ПроцентОсновнойПремии = new Guid("d22bd0a2-bbc6-4ddc-a07f-cfdda45cae73");
            public static readonly Guid CalcNormByOtherProf = new Guid("794b1c00-78cb-4bfd-ba65-3da1162829d9");   //Вычисление сверхномр по остальным профессиям
            public static readonly Guid LinkTariffGuid = new Guid("bdfb578f-d036-4f52-956d-0b1fd702c1b6"); //Связь с тарифной ставкой
            public static readonly Guid СвязьВыполняемойРаботыСПрофессией = new Guid("32766c20-dbe8-41bc-a2eb-6a52c247ea96");
            public static readonly Guid ПроцентПремииПрофессии = new Guid("a21db8c7-fe96-4839-aa37-f74363a6903b");
            public static readonly Guid LinkTariffGroupsGuid = new Guid("ba2c3050-6b7d-4fce-aa83-36dcce15eda3"); //связь с тарифной группой
            public static readonly Guid DismissedGuid = new Guid("ff5be7db-820f-44d6-9d72-f3f162e87ebc");  //Уволен  
            public static readonly Guid PartTimeWorker = new Guid("58111e72-437d-42e7-910a-2df5376660dc");  //Совместитель
            public static readonly Guid СвязьТарифнойГруппыСоСтоимостьюЧасовСвышеНорм = new Guid("ffada72a-7c0f-48c9-81b8-326f0d9bcdc2");
        }
