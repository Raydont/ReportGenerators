...
namespace ReportHelpers
{
    public class Xls : IDisposable
    {
        ...
        public void OpenRead(string workBookPath, bool saveLast = true)
        {
            ...
            _worksheet = null;
            _workBook = Application.Workbooks.Open(workBookPath, ReadOnly: true, AddToMru: false, CorruptLoad: XlCorruptLoad.xlNormalLoad);
        }
        ...
        internal void EnshureWorksheetCount(int count)
        {
            while (WorkBook.Worksheets.Count < count)
            {
            ...
            {
                SelectWorksheet(i + 1);
                Worksheet.Name = "Лист " + (i + 1).ToString().Trim();
            }
    ...
    public static class XlsExtender
    {
        ...
        public static void AlignVertical(this Range range, XlVAlign valign)
        {
            range.VerticalAlignment = valign;
        }

        public static void AlignHorizontal(this Range range, XlHAlign halign)
        {
            range.HorizontalAlignment = halign;
        }

        public static void CenterVertical(this Range range)
        {
            range.VerticalAlignment = XlVAlign.xlVAlignCenter;
        }

        public static void CenterHorizontal(this Range range)
        {
            range.HorizontalAlignment = XlHAlign.xlHAlignCenter;
        }
        ...
        public static void ClearBorders(this Range range, XlLineStyle style = XlLineStyle.xlContinuous, XlBorderWeight weight = XlBorderWeight.xlMedium,
            params XlBordersIndex[] borders)
        {
            foreach (var xlBordersIndex in borders)
            {
