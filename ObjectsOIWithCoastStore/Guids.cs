...
namespace ObjectsOIWithCoastStore
{
    public class Guids
    {
        ...
        public class References
        {
            ...
            public static readonly Guid NomStoreGuid = new Guid("020d64f8-5ccb-41c2-ada1-e4e551c1bbf1");                //Справочник Номенклатура складов
        }
        ...
        {
            public static readonly Guid Name = new Guid("e434c150-94e4-4cb6-a1de-9fc8b6408380");
            public static readonly Guid INN = new Guid("a21b20b3-83c4-4e81-83d7-2a6a77efdead");
        }
        ...
        public static class NomHierarchyLink
        {
            public static class Fields
            {
                ...
                public static readonly Guid NotIncludeCalculateSum = new Guid("2d99163a-9343-4f93-936a-c39ff9e999b7");
            }
        }

        public static class Failure
        {
            internal static readonly Guid RefId = new Guid("37eaa771-2976-4f29-b390-8e58468c8a70");

            public static class Types
            {
                public static readonly Guid Fail = new Guid("02fff743-e523-4a57-ad62-bc8d217af906");
            }

            public static class Params
            {
                public static readonly Guid NameOtherItems = new Guid("d2396f74-cb28-4832-84d3-922631ab143c");
                public static readonly Guid DateSZ = new Guid("cf95f18e-898c-4ea8-bdfa-e9248bc45dad");
                public static readonly Guid NumberSZ = new Guid("f4505703-7137-4118-a2cf-0aafa408d4e2");
                public static readonly Guid Count = new Guid("a013d44e-a3d3-4620-81b0-93d4152c8167");
            }

            public static class Links
            {
                public static readonly Guid OtherItemsListObjects = new Guid("ca79a8ed-2057-4707-810b-bbe80a327b22");
            }
        }
