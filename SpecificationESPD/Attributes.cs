...
namespace SpecificationESPD
{
    public partial class Attributes : Form
    {
        ...
        public void DotsEntry(IReportGenerationContext context)
        {
            ...
            if ((chBoxTitul.CheckState == CheckState.Checked)||(chBoxLU.CheckState == CheckState.Checked))
            {
                ...
                if (chBoxLU.CheckState == CheckState.Checked)
                {
                    ...
                    documentAttr.Goev = comboBoxChiefDesigner.Text;
                    if (chBoxMilitaryChief.CheckState == CheckState.Checked)
                    {
                        documentAttr.MilitaryChief = comboBoxChiefVPMO.Text;
                        documentAttr.CheckMilitaryChief = true;
                    }
                    else documentAttr.CheckMilitaryChief = false;

                    documentAttr.Designer = comboBoxMaker.Text;
                    documentAttr.Norm = comboBoxRateChecker.Text;

                    if (chBoxChiefTeam.CheckState == CheckState.Checked)
                    {
                        documentAttr.ChiefTeam = comboBoxChiefTeam.Text;
                    ...
                    {
                        documentAttr.VPMO = comboBoxRepresentative.Text;
                    ...
                    {
                        documentAttr.SurnameZgkz = comboBoxZGKZ.Text;
        ...
        {
            if (chBoxMilitaryChief.CheckState == CheckState.Checked)
                comboBoxChiefVPMO.Enabled = true;
            else comboBoxChiefVPMO.Enabled = false;
        }

        private void chBoxChiefTeam_CheckedChanged(object sender, EventArgs e)
        {
            if (chBoxChiefTeam.CheckState == CheckState.Checked)
                comboBoxChiefTeam.Enabled = true;
            else comboBoxChiefTeam.Enabled = false;
        }
        ...
        private void chBoxVPMO_CheckedChanged(object sender, EventArgs e)
        {
            ...
            else comboBoxRepresentative.Enabled = false;
        }
        ...
        {
            if (chBoxZgkz.CheckState == CheckState.Checked)
                comboBoxZGKZ.Enabled = true;
            else comboBoxZGKZ.Enabled = false;
        }
    }
}
