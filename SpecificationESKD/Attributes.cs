...
namespace SpecificationESKD
{
    public partial class Attributes : Form
    {
        ...
        private void cbZeroToDash_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void tbApprovedBy_TextChanged(object sender, EventArgs e)
        {

        }

        private void chBoxDocumentation_CheckedChanged_1(object sender, EventArgs e)
        {
        ...
        private void chBoxSortByAlphabet_CheckedChanged(object sender, EventArgs e)
        {
